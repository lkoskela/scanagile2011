...
public class LogFileTransformerTest {
	...
	@Before
	public void prepareTransformedFile() {
	...
	@Test
	public void transformationGeneratesCorrectLookingStuffIntoTheRightFile()
			throws Exception {
	...
	private void appendTo(StringBuilder buffer, String line) {
